...
export default function HomePage({ user, userInterviews, allInterview }: HomePageProps) {
  ...
  if (!user && !isGuestMode) {
    ...
    const guestModeEnabled = typeof window !== 'undefined' && localStorage.getItem("guestMode") === "true";
  ...
  // Debug logging
  console.log("HomePage - isGuestMode:", isGuestMode);
  console.log("HomePage - currentUser:", currentUser);
  console.log("HomePage - localStorage guestMode:", typeof window !== 'undefined' ? localStorage.getItem("guestMode") : "server-side");
        ...
        <div className="flex flex-col gap-6 max-w-lg">
          ...
          {isGuestMode && (
            <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded">
              <p className="text-sm">
                <strong>🎉 Guest Mode Active!</strong> You're exploring the app as a guest. 
                <button 
